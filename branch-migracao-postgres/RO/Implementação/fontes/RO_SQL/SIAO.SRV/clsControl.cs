    ...
    public class clsControl
    {
        ...
        public string AddUser(UsersTO clsUser, string scn)
        {
            ...
            try
            {
                ...
                if (oDB.openConnection(cmm))
                {
                    ...
                    cmm.Parameters.Add("@UserName", DbType.String).Value = clsUser.Name;
                    ...
                    if (oDB.Query(id, ref cmm) == DBNull.Value)
                    {
                        ...
                        cmm.Parameters.Clear();
                        cmm.Parameters.Add("@UserName", DbType.String).Value = clsUser.Name;
                        cmm.Parameters.Add("@LastActivityDate", DbType.DateTime).Value = lDate;
        ...
        public System.Data.DataSet GetUser(string scn, string p)
        {
            ...
            cmm.CommandText = "SELECT users.UserName, memberships.UserId"
                ...
                + " AND (memberships.ExpirationDate > GETDATE())";
            ...
            if (ds.Tables.Count > 0)
            {
                try
                {
                    if (oDB.openConnection(cmm))
                    {
                        ...
                        cmm.Parameters.Clear();
                        cmm.Parameters.Add("@cnpj", DbType.String).Value = ds.Tables[0].Rows[0]["cnpj"].ToString();
                        cmm.Parameters.Add("@mes", DbType.Int32).Value = ds.Tables[0].Rows[0]["mes"];
                        cmm.Parameters.Add("@ano", DbType.Int32).Value = ds.Tables[0].Rows[0]["ano"];
                        ...
                        if (oDB.Query(id, ref cmm) == DBNull.Value)
                        {
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                cmm.Parameters.Clear();
                                cmm.Parameters.Add("@Cnpj", DbType.String).Value = ds.Tables[0].Rows[i]["cnpj"].ToString();
                                cmm.Parameters.Add("@Mes", DbType.Int32).Value = ds.Tables[0].Rows[i]["mes"];
                                cmm.Parameters.Add("@Ano", DbType.Int32).Value = ds.Tables[0].Rows[i]["ano"];
                                cmm.Parameters.Add("@Barras", DbType.String).Value = ds.Tables[0].Rows[i]["ean"].ToString();
                                cmm.Parameters.Add("@Descricao", DbType.String).Value = ds.Tables[0].Rows[i]["nprod"].ToString();
                                cmm.Parameters.Add("@Fabricante", DbType.String).Value = ds.Tables[0].Rows[i]["fab"].ToString();
                                cmm.Parameters.Add("@Quantidade", DbType.Int32).Value = ds.Tables[0].Rows[i]["quant"];
                                cmm.Parameters.Add("@Valor_Bruto", DbType.Decimal).Value = ds.Tables[0].Rows[i]["vbruto"];
                                cmm.Parameters.Add("@Valor_Liquido", DbType.Decimal).Value = ds.Tables[0].Rows[i]["vliquido"];
                                cmm.Parameters.Add("@Valor_Desconto", DbType.Decimal).Value = ds.Tables[0].Rows[i]["desconto"];
            ...
            if (ds.Tables.Count > 0)
            {
                try
                {
                    if (oDB.openConnection(cmm))
                    {
                        ...
                        cmm.Parameters.Clear();
                        cmm.Parameters.Add("@UserId", DbType.Int32).Value = clsUser.UserId;
                        cmm.Parameters.Add("@cnpj", DbType.String).Value = ds.Tables[0].Rows[0]["cnpj"].ToString();
                        cmm.Parameters.Add("@mes", DbType.Int32).Value = ds.Tables[0].Rows[0]["mes"];
                        cmm.Parameters.Add("@ano", DbType.Int32).Value = ds.Tables[0].Rows[0]["ano"];
            ...
            if (dt.Rows.Count > 0)
            {
                try
                {
                    if (oDB.openConnection(cmm))
                    {
                        ...
                        using (SqlBulkCopy sbcTxt = new SqlBulkCopy(scn)) {
                            sbcTxt.DestinationTableName = "base_clientes";
                            sbcTxt.ColumnMappings.Add(0, "Razao_Social");
                            sbcTxt.ColumnMappings.Add(1, "Cnpj");
                            sbcTxt.ColumnMappings.Add(2, "Mes");
                            sbcTxt.ColumnMappings.Add(3, "Ano");
                            sbcTxt.ColumnMappings.Add(4, "Barras");
                            sbcTxt.ColumnMappings.Add(5, "Descricao");
                            sbcTxt.ColumnMappings.Add(6, "Fabricante");
                            sbcTxt.ColumnMappings.Add(9, "Quantidade");
                            sbcTxt.ColumnMappings.Add(10, "Valor_Bruto");
                            sbcTxt.ColumnMappings.Add(11, "Valor_Liquido");
                            sbcTxt.ColumnMappings.Add(12, "Valor_Desconto");
                            sbcTxt.WriteToServer(dt);
                        }
                    }
                }
                catch (Exception ex)
            ...
            if (dt.Rows.Count > 0)
            {
                try
                {
                    if (oDB.openConnection(cmm))
                    {
                        ...
                        cmm.Parameters.Clear();
                        cmm.Parameters.Add("@UserId", DbType.Int32).Value = clsUser.UserId;
                        cmm.Parameters.Add("@cnpj", DbType.String).Value = dt.Rows[0]["cnpj"].ToString();
                        cmm.Parameters.Add("@mes", DbType.Int32).Value = dt.Rows[0][2];
                        cmm.Parameters.Add("@ano", DbType.Int32).Value = dt.Rows[0]["ano"];
        ...
        public Loja GetLojaEdit(string scn, string p)
        {
            ...
            cmm.Parameters.Clear();
            cmm.Parameters.Add("@Id", DbType.Int32).Value = p;
        ...
        public object GetLojaByUserId(string scn, UsersTO clsUser)
        {
            ...
            if (!clsUser.Access.Equals("adm"))
            {
                ...
                cmm.Parameters.Clear();
                cmm.Parameters.Add("@GerenteId", DbType.Int32).Value = clsUser.UserId;
                cmm.Parameters.Add("@ProprietarioID", DbType.Int32).Value = clsUser.UserId;
            }
