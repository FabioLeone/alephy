	...
	public class UsersBLL
	{
		...
		public static UsersTO GetUserSession()
		{
			...
			if (HttpContext.Current.Session[of.encr(strName)] != null)
				return (UsersTO)jssObject.Deserialize<UsersTO>(of.denc((string)HttpContext.Current.Session[of.encr(strName)]));
			else
				return objUser;
		}
		...
		public static bool ValidaAcesso(UsersTO users, Control dvRedes, Control dvLoja, Control dvFiltro)
		{
			switch (users.TipoId)
			{
			case 1:
